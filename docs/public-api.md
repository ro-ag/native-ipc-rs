...
| `native_ipc::{region,batch,control,active,binding,session}` | Experimental vNext (released in 0.5) | Experimental source API. Names and details may change between 0.x releases per vNext spec §16. |
